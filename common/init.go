...
func InitEnv() {
	...
	GitHubClientId = GetEnvOrDefaultString("GITHUB_CLIENT_ID", "")
	GitHubClientSecret = GetEnvOrDefaultString("GITHUB_CLIENT_SECRET", "")
	GoogleClientId = GetEnvOrDefaultString("GOOGLE_CLIENT_ID", "")
	GoogleClientSecret = GetEnvOrDefaultString("GOOGLE_CLIENT_SECRET", "")
	LinuxDOClientId = GetEnvOrDefaultString("LINUXDO_CLIENT_ID", "")
	LinuxDOClientSecret = GetEnvOrDefaultString("LINUXDO_CLIENT_SECRET", "")
