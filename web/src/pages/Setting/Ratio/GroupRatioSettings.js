...
// 导入可视化编辑器组件
import VisualGroupRatioEditor from './VisualGroupRatioEditor';
import VisualUsableGroupsEditor from './VisualUsableGroupsEditor';
import VisualGroupGroupRatioEditor from './VisualGroupGroupRatioEditor';
import VisualAutoGroupsEditor from './VisualAutoGroupsEditor';
...
export default function GroupRatioSettings(props) {
  ...
  const [visualMode, setVisualMode] = useState({
    GroupRatio: false,
    UserUsableGroups: false,
    GroupGroupRatio: false,
    AutoGroups: false,
  });
