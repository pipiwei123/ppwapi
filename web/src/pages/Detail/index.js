        ...
        >
          ...
          >
            <div className="h-[32rem] p-2">
              {activeChartTab === '0' && (
                <div className="h-full w-full grid grid-cols-1 md:grid-cols-2 gap-2 overflow-auto p-2">
                  {(() => {
                    ...
                    userRank.slice(0, 10).forEach((item, index) => {
                      ...
                      renderItems.push(
                        <div
                          key={`user-${index}`}
                          className={`flex items-center justify-between p-4 rounded-xl transition-all duration-300 ease-in-out cursor-pointer ${styles.container}`}
                        >
                    ...
                    for (let i = 0; i < remainingSlots; i++) {
                      const rank = userRank.length + i + 1;
                      renderItems.push(
                        <div
                          key={`empty-${i}`}
                          className="flex items-center justify-between p-4 rounded-xl border-2 border-dashed border-gray-200 bg-gray-50 opacity-60"
                        >
                          <div className="flex items-center gap-4 flex-1 min-w-0">
                            <div className="flex-shrink-0 flex items-center justify-center w-8 h-8">
